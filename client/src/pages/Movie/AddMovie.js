...
const AddMovie = ({ addMusic, film }) => {
  ...
  const onSubmit = (e) => {
    ...
    addMusic(payload, redirectToMovieList);
          ...
          <div className="satuline">
            ...
            <div className="form-group">
              <button
                type="button"
                onClick={() => {
                  document.getElementsByName("thumbnailFilm")[0].click();
                }}
                className="btn-grey"
                style={{
                  width: "40%",
...
export default connect(mapStateToProps, { addMusic })(AddMovie);
